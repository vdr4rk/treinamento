...
INSERT INTO public.tb_pessoa ( no_nome, ds_email, dt_nascimento, st_pessoa) VALUES ( 'Pedro', 'joaom.dev@hotmail.com1', '1995-08-25', true);
...
insert into tb_pessoa_perfil(co_seq_pessoa, co_seq_perfil) VALUES ((select co_seq_pessoa from tb_pessoa where no_nome = 'Pedro'),
...
VALUES (DEFAULT, (select co_seq_pessoa from tb_pessoa where no_nome = 'Pedro'), 'Gemétris Chácara 3', 'CASA X', 'Vicente Pires', 'Brasília', 'DF', '72001100');